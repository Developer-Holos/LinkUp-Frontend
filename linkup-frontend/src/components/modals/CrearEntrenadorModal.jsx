...
const CrearEntrenadorModal = ({ open, onClose, onSave }) => {
  ...
  const sedes = ['Sede X', 'Sede Norte', 'Sede Sur', 'Sede Este', 'Sede Oeste'];
  ...
  return (
    ...
    >
      ...
      <DialogContent sx={{ pt: 2 }}>
        ...
        {/* Sede */}
        <Typography variant="subtitle1" sx={{ mb: 2, fontWeight: 500, color: '#059669' }}>
          Sede
        </Typography>
...
export default CrearEntrenadorModal;